...
当前阶段：P0 基线与里程碑 D 的核心桌面组件已实现；其余 P1/P2、真实业务项目接入和平台增强仍在规划中。
...
已实现的公开组件除 P0 外，还包括 Overlay、SplitPane、Tabs、PopupMenu、PopupMenuItem、ContextMenu、Table、Tree、Form、Toast、ModalDialog 和 ConfirmDialog。逐项能力与限制见 [`docs/p1-status.md`](docs/p1-status.md)。
