...
当前阶段：P0 组件与 Gallery 基线已实现；真实业务项目接入和平台增强仍在规划中。
...
已实现的公开组件：Theme、Typography、Label、Icon、Surface、Divider、FocusRing、ScrollArea、Stack、Space、Card、Button、IconButton、ToolButton、Toolbar、Checkbox、Switch、TextField、Select、SegmentedControl、FormRow、SettingsSection、Tooltip、Progress、Spinner、EmptyState、StatusBar。
