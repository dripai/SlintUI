...
当前阶段：全部 P0、P1、P2 核心组件均已实现，共 86 份组件规格；原 58 个组件的质量复核和剩余 28 个 P1 条目已完成。真实业务项目接入、三平台真机验证和平台增强统一记录在 [`TODO.md`](TODO.md)。
...
已实现的公开组件覆盖基础、布局、操作、导航、数据录入、数据展示、反馈和桌面核心分类。逐项 API 与限制见 [`design/component-specs/`](design/component-specs/README.md)，质量证据见 [`design/component-quality-audit.md`](design/component-quality-audit.md)，未完成工作见 [`TODO.md`](TODO.md)。
...
首个固定 P0 基线为 Git Tag `v0.1.0`；目标范围见 [`design/component-inventory.md`](design/component-inventory.md)，已实现组件见 [`design/component-specs/`](design/component-specs/README.md)，后续工作见 [`TODO.md`](TODO.md)。
