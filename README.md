...
当前阶段：P0 基线、里程碑 D 的核心桌面组件和里程碑 E 的全部 P2 核心组件已实现；现有组件质量补齐、剩余 28 个 P1 条目、真实业务项目接入和平台增强统一记录在 [`TODO.md`](TODO.md)。
...
已实现的公开组件除 P0 外，还包括里程碑 D 的 Overlay、SplitPane、Tabs、菜单、Table、Tree、Form、Toast 与 Dialog，以及里程碑 E 的 20 个 P2 组件。逐项 API 与限制见 [`design/component-specs/`](design/component-specs/README.md)，未完成工作见 [`TODO.md`](TODO.md)。
...
未完成的质量、平台和产品验证任务见 [`TODO.md`](TODO.md)。
