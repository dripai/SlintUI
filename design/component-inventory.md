...
每个组件的状态为“待实现”“实现中”“已完成”之一。当前仓库已完成全部 P0、提前完成的 `ScrollArea`，以及里程碑 D 的 Overlay、PopupMenu、PopupMenuItem、ContextMenu、Tabs、Table、Tree、ModalDialog、ConfirmDialog、Toast、SplitPane 和 Form；其余 P1/P2 与平台增强仍为待实现。逐组件状态、API 和限制见 [`component-specs/`](component-specs/README.md)。
