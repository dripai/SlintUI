...
图标资产使用 `24 × 24` 标准画布和矢量源文件，12、16、20、24px 为标准显示尺寸。系统操作图标默认使用轮廓风格；Filled 只用于选中、强状态或品牌图形。图标命名使用“对象-动作-状态”，方向性图标必须声明 RTL 下是否镜像。复杂图形需要分别进行 12px 和 16px 光学校正，不能只缩放 24px 原稿。
